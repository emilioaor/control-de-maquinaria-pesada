    ...
    <div class="header">	
  	...
  	<div class="main">
	 	<div class="titulos">
			...
			<h2>Pagos</h2>
			<hr>
			<p>Debera seleccionar de la lista de solicitudes la que desee pagar y luego registrar los datos del pago que le sean solicitados.</p>
		</div>
			...
			?>
					<div class="maq">
						...
						<?php if($estatus=='Pendiente'){ ?>
								...
								<div id="espacio_btn">
									<form method="post" action="cliente-procesar-pago.php">
