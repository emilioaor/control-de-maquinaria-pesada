    ...
    <div class="header">	
  	...
  	<div class="main">
	 	<div class="titulos">
			...
			<h2>BIENVENIDO</h2>
			<hr>
			<p>Este es el area de clientes. Desde aqui podra comprobar la maquinaria disponible, administrar solicitudes y registrar los pagos por el servicio.</p>
		</div>

		<div id="menu">
			<div class="icono">
				<a href="cliente-maquinaria.php">
					<img src="images/icono_maquinaria.png"><br>
					<p>Maquinaria</p>
				</a>
			</div>
			<div class="icono">
				<a href="cliente-lista-solicitudes.php">
