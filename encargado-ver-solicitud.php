  	...
  	<div class="main">
		...
		<div id="lista-maquinaria">
			<div id="barra_maquinaria">
				<a href="encargado-solicitud.php" class="btn boton_atras">Ir Atras</a>
			...
			<div class="div_centrar">
				...
				<?php if($estatus=='Por Aprobar'){ ?>
						<form method="post" action="php/aprobar-solicitud.php" class="form-aprobar">
				...
				<?php if($estatus=='Pendiente' || $estatus=='Por Aprobar'){ ?>
						<form method="post" action="php/cancelar-solicitud.php" <?php if($estatus=='Por Aprobar'){ ?>class="form-aprobar" <?php } ?> >
							<input type="hidden" name="cod_solicitud" value="<?php echo $codigo_solicitud ?>">
				...
				<?php if($estatus=='Aprobada'){ ?>
						<form method="post" action="php/recibir-solicitud.php" >
							<input type="hidden" name="cod_solicitud" value="<?php echo $codigo_solicitud ?>">
