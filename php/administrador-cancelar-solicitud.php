<?php
	...
	//cambiar estatus de la solicitud a : Cancelada
	$q="update solicitud set estatus='Cancelada' where codigo=$cod_solicitud";
	...
	echo "<script type='text/javascript'>alert('Solicitud Cancelada');</script>";
