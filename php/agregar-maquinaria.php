<?php
	...
	//Agregar maquinaria
	$q ="insert into maquinaria values('$placa',$cod_modelo,'Disponible')";
	...
	//despedida
	echo "<script type='text/javascript'>alert('Maquinaria Agregada');</script>";
	echo "<script type='text/javascript'>location.href='../administrador-maquinaria.php';</script>";
